...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static cityPlaceholder() => "Введіть Ваше місто тут...";
  ...
  static documentTextPlacehlder() => "Введіть текст документу тут...";

  static documentVoteHoldButton() => "Утримуюсь";

  static documentVoteNoButton() => "Відкидаю";

  static documentVoteYesButton() => "Підтримую";
  ...
  static namePlaceholder() => "Введіть Ваше ім\'я тут...";

  static phone() => "Телефон: ";

  static phonePlaceholder() => "Введіть Ваш телефон тут...";
  ...
  final messages = const {
    ...
    "documentNamePlaceholder" : documentNamePlaceholder,
    "documentTextMessage" : documentTextMessage,
    "documentTextPlacehlder" : documentTextPlacehlder,
    "documentVoteHoldButton" : documentVoteHoldButton,
